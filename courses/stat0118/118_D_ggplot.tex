...
\hypersetup{
  pdftitle={Making plots with ggplot2: Barplots and Scatterplots},
...
\title{Making plots with \texttt{ggplot2}: Barplots and Scatterplots}
...
\item[5CB6E08D-list-annote-4]
only include the language and mother\_tongue columns
\item[5CB6E08D-list-annote-5]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, arc=.35mm, breakable, leftrule=.75mm, opacityback=0, toprule=.15mm, rightrule=.15mm, colback=white, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, bottomrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, titlerule=0mm, colframe=quarto-callout-tip-color-frame, bottomtitle=1mm, toptitle=1mm, left=2mm, coltitle=black]
