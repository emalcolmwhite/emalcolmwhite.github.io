...
:::{.callout-tip title="Downloads"}

- [📖 Notes .qmd](courses/stat0118/{{< page.file >}})
- [📝️ Notes Template .qmd](courses/stat0118/{{< page.file | path.splitext | first }}_notes.qmd)
- [📚 Homework .qmd](courses/stat0118/{{< page.file | path.splitext | first }}_homework.qmd)
:::
