...
Repeat your plot for #2 for all years in the dataset. Hint: you'll need to make sure you are using the full dataset for all years (not just 2007 like in the previous plots) AND you can use a nifty function that we talked about to repeat the analysis for all years in only one line of code! 
