...
\subsection{\texorpdfstring{The \texttt{tidyverse}
package}{The tidyverse package}}\label{the-tidyverse-package}}

In this class we will use the \texttt{tidyverse} package a lot.
...
{\centering \includegraphics[width=0.8\textwidth,height=\textheight]{images/tidyverse_packages.png}
...
\section[\texttt{can\_lang} dataset ]{\texorpdfstring{\texttt{can\_lang}
dataset
\protect\includegraphics[width=0.1\textwidth,height=\textheight]{118_B_wrangling_files/mediabag/hex-canlang.png}}{can\_lang dataset }}\label{can_lang-dataset}}
...
{\centering \includegraphics[width=0.6\textwidth,height=\textheight]{118_B_wrangling_files/mediabag/cb8d9c50-f48e-4c6d-a.png}
...
\texttt{\%\textgreater{}\%} means apply the action on the following line
...
{\centering \includegraphics[width=0.6\textwidth,height=\textheight]{118_B_wrangling_files/mediabag/bd4ae264-ae51-4d18-b.png}
